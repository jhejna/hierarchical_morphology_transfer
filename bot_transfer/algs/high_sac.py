...
class HighSAC(OffPolicyRLModel):
    """
    ...
    def __init__(self, policy, env, gamma=0.99, learning_rate=3e-4, buffer_size=50000,
        ...
        super(HighSAC, self).__init__(policy=policy, env=env, replay_buffer=None, verbose=verbose,
    ...
    def learn(self, total_timesteps, callback=None,
        ...
        with SetVerbosity(self.verbose), TensorboardWriter(self.graph, self.tensorboard_log, tb_log_name, new_tb_log) \
            ...
            for step in range(total_timesteps):
                ...
                _, _, last_done, info = self.env.step(unscaled_action)
                ...
                for i in range(len(rewards)):
                    self.replay_buffer.add(observations[i], scale_action(self.action_space, actions[i]), rewards[i], observations[i+1], float(dones[i]))
